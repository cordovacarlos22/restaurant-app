...
const Chef = () => (
  <div className="chef-main-container">
    ...
    <div className="about-chef">
      <h4 className="world-chef">Chef's World</h4>
      <img className="chef-spoon" src={Spoon} alt="spoon"></img>
      <h1 className="chef-title">What We Belive In</h1>
      <p className="chef-paragraph">
        <img className="quotes" src={Quote} alt="quote"></img>Lorem ipsum, dolor
        sit amet consectetur adipisicing elit. Amet excepturi aliquam
        voluptatibus, inventore cumque repudiandae veritatis, omnis suscipit
        maiores molestias expedita alias consectetur ipsam libero voluptate
        nobis sint nihil error!
      </p>{" "}
      <br />
